...
userController.getUserById = async (req, res) => {
  try {
    ...
    res.status(200).send(responseObject(200, true, 'User fetched successfully', user))
  } catch (error) {
    console.error(error)
    res.status(500).send(responseObject(500, false, 'Internal server error', null))
  }
...
userController.updateUser = async (req, res) => {
  try {
    ...
    res.status(200).send(responseObject(200, true, 'User updated successfully', user))
  } catch (error) {
    console.error(error)
    res.status(500).send(responseObject(500, false, 'Internal server error', null))
  }
...
userController.deleteUser = async (req, res) => {
  try {
    ...
    res.status(200).send(responseObject(200, true, 'User deleted successfully', user))
  } catch (error) {
    console.error(error)
    res.status(500).send(responseObject(500, false, 'Internal server error', null))
  }
...
userController.login = async (req, res) => {
  try {
    ...
    if (user) {
      ...
      res.status(401).send(responseObject(401, false, 'Invalid credentials', null))
    }
  } catch (error) {
    console.error(error)
    res.status(500).send(responseObject(500, false, 'Internal server error', null))
...
userController.register = async (req, res) => {
  try {
    ...
    if (user) {
      user.token = tokenGenerator(user)
      res.status(201).send(responseObject(201, true, 'Registration successful', user))
    } else {
      res.status(400).send(responseObject(400, false, 'Registration failed', null))
    }
  } catch (error) {
    console.error(error)
    res.status(500).send(responseObject(500, false, 'Internal server error', null))
